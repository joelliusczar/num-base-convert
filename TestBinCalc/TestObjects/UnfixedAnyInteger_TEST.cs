...
{
    class UnfixedAnyInteger_TEST: UnfixedAnyInteger
    {
        public UnfixedAnyInteger_TEST(NumberBases choice, string input)
            : base(choice, input)
        {
            Console.Write("UnfixedAnyInteger_TEST Instantiation!\n");
